...
#F
execute if entity @p[nbt={Inventory:[{Slot:-106b,id:"minecraft:carrot_on_a_stick",tag:{Tags:["mrg_detector"]},Count:1b}]},tag=mrg_player] run function minecraft_rythm_game:rythm_game/f_detected
